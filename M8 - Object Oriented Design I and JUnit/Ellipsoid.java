...
public class Ellipsoid {
   ...
   */
   ...
   /**
   *accepts no parameters.
   *@return count for number of ellipsoids
   *calculates number of ellipsoids
   */
   ...
   */
   ...
   /**
   *@param obj that is used for class.
   *checks to see if the ellipsoids are equal to each other
   *@return ellipsoid if it matches
   **/
