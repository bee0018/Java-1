...
public class MainApp {
    public static void main(String[] args) {
         ...
         */
        // Possibly put in another button for which UI run based upon the buttons.

       StoreManager.getInstance().getUserPath().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
       StoreManager.getInstance().getUserPath().setVisible(true);
